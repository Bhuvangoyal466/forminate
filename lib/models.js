...
export class FormModel {
    static async create(formData, userId) {
        ...
        // Get user details to store with the form
    ...
    static async findByUserId(userId, page = 1, limit = 10) {
        ...
        const total = await db.collection("forms").countDocuments(query);
    ...
    static async update(id, updateData, userId) {
        ...
        // Remove _id and createdBy fields from updateData to prevent immutable field errors
        const { _id, createdBy, ...cleanUpdateData } = updateData;
